...
def main():
    ...
    quantized_model_filename = "qat_resnet18_cifar10.pt"
    model_filepath = os.path.join(model_dir, model_filename)
    # model_filepath = "/content/drive/MyDrive/DeepLearning/PyTorch-Static-Quantization/saved_models/resnet18_cifar10.pt"
